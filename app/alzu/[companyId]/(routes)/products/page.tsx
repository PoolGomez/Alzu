...
const ProductsPage = async({params}:{params: Params}) => {
  ...
  const validateCreateProduct = userData.companiesUserRoles.some((item)=>item.role.permissions.includes("CREATE_PRODUCT"))
  const validateEditProduct = userData.companiesUserRoles.some((item)=>item.role.permissions.includes("EDIT_PRODUCT"))
  const validateDeleteProduct = userData.companiesUserRoles.some((item)=>item.role.permissions.includes("DELETE_PRODUCT"))
